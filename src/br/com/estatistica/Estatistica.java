...
System.out.print("\n Desvio Padrão Amostral: "+ new BigDecimal(e.getDesvioPadrao()).setScale(1, RoundingMode.HALF_EVEN));
System.out.print("\n Desvio Padrão Populacional: "+ new BigDecimal(e.getDesvioPadrao()).setScale(1, RoundingMode.HALF_EVEN));
System.out.print("\n Variância Amostral: "+ new BigDecimal(e.getVariancia()).setScale(1, RoundingMode.HALF_EVEN));
System.out.print("\n Variância Populacional: "+ new BigDecimal(e.getVariancia()).setScale(1, RoundingMode.HALF_EVEN));
System.out.print("\n Coeficiente Variação Amostral: "+ new BigDecimal(e.getCoeficienteVariacao()).setScale(1, RoundingMode.HALF_EVEN));
}
}